...
class Service_Category extends Widget_Base {
	...
	public function get_title() {
		return __( 'Galaxy Service Category', 'elementor-galaxypro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .heading .subtitle a',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => '#f85032',
				'selectors' => [
					'{{WRAPPER}} .heading .subtitle a:hover' => 'color: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="heading">
			<h6 class="subtitle mt-30" style="text-align:<?php echo $settings['text_align']; ?>">
			<?php 
				$id = get_the_id();
				$categories = get_the_terms( $id, 'service_cat' );
